  ...
  const page = (
    <html lang="ja">
      ...
      <body class="m-0 p-0 min-h-full bg-[var(--base)]">
        <main class="max-w-800px mx-auto px-8 py-16 font-[var(--font-body)] text-[var(--main)]">
              ...
              {items.map((d) => (
                <li>
                  <a
                    ...
                    class="grid grid-cols-[240px_1fr] items-center gap-5 no-underline color-inherit p-3 rounded-2.5 transition-colors hover:bg-[var(--muted)]"
                  >
